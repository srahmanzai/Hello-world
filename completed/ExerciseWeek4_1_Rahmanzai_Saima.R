...
## as still figuring out the apply.  Instead I resorted to aggregated.
...
## I used the aggregate that that tells me the total score by Segment.  It provides the following results:
