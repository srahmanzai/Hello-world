...
The relationship is linear. In the situation where the scatter plots show curved patterns, we are dealing with nonlinear association between the two variables.  We ran Use Shapiro-Wilk normality test and the ggqplot test for normality.  Appears to be a normal distribution.
