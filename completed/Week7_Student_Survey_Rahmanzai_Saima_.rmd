...
The correlation coefficients are calculated for our paired variable under section i above.  The coefficient of determination is calculated with the following formula:
