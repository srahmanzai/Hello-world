...
##Since my table is flipped, colSums() below gives my each student points while colsums() gives me the total ##assignment points
colSums(grades)
...
###### I rewrote the #formula as shown in the class text book

recommendations_vector <- c("neutral", "no", "no", "neutral", "yes")
factor_recommendations_vector <- as.factor(recommendations_vector)
factor_recommendations_vector

factor(x=recommendations_vector,levels=c("no", "neutral", "yes"),ordered=TRUE)
